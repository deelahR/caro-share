...
test("removes starter preview code and documents Render deployment", async () => {
  ...
  assert.match(page, /summary-filter-panel/);
  assert.match(page, /summary-filter-note/);
  ...
  assert.match(page, /openShortcut/);
  assert.match(page, /openNotificationShortcut/);
  assert.match(page, /Open approval requests/);
  assert.match(page, /Open equipment items/);
  ...
  assert.match(globalsCss, /\.summary-filter-panel/);
  assert.match(globalsCss, /\.summary-filter-note/);
  ...
  assert.match(postgres, /owners_lower_name_idx/);
  assert.match(postgres, /business_entries_status_created_idx/);
  assert.match(postgres, /business_entries_accepted_owner_type_date_idx/);
  assert.match(postgres, /business_entries_pending_created_idx/);
  assert.match(postgres, /entry_approvals_entry_created_idx/);
  assert.match(postgres, /equipment_items_status_created_idx/);
  assert.match(postgres, /equipment_items_owner_status_date_idx/);
  assert.match(postgres, /equipment_add_requests_status_created_idx/);
  assert.match(postgres, /equipment_delete_requests_status_created_idx/);
  assert.match(postgres, /owner_notifications_unread_idx/);
  assert.match(postgres, /with entry_stats as/);
  assert.match(postgres, /cross join equipment_stats/);
